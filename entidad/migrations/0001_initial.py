    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ciudad_idciudad', models.ForeignKey(db_column='ciudad_idCiudad', on_delete=django.db.models.deletion.DO_NOTHING, to='pais.ciudad')),
            ],
            options={
                'db_table': 'entidad',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.IntegerField()),
                ('id_recursos_entidad', models.ForeignKey(db_column='id_recursos_entidad', on_delete=django.db.models.deletion.DO_NOTHING, to='entidad.recursosentidad')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_registro', models.DateTimeField()),
                ('eliminado', models.IntegerField()),
                ('identidad', models.ForeignKey(db_column='idEntidad', on_delete=django.db.models.deletion.DO_NOTHING, to='entidad.entidad')),
            ],
            options={
                'db_table': 'emoticon',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descripcion', models.TextField()),
                ('eliminado', models.IntegerField()),
                ('id_recurso_entidad', models.ForeignKey(db_column='id_recurso_entidad', on_delete=django.db.models.deletion.DO_NOTHING, to='entidad.recursosentidad')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_canal', models.ForeignKey(db_column='tipo_canal', on_delete=django.db.models.deletion.DO_NOTHING, to='entidad.tipocanal')),
            ],
            options={
                'db_table': 'canal',
                'managed': True,
